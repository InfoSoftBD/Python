...
txtCustomer_id=tk.Entry(frmProduct)
txtCustomer_id["borderwidth"] = "1px"
ft = tkFont.Font(family='Times',size=10)
txtCustomer_id["font"] = ft
txtCustomer_id["fg"] = "#333333"
txtCustomer_id["justify"] = "left"
txtCustomer_id.place(x=30,y=100,width=91,height=30)

txtCustomer_name=tk.Entry(frmProduct)
txtCustomer_name["borderwidth"] = "1px"
ft = tkFont.Font(family='Times',size=10)
txtCustomer_name["font"] = ft
txtCustomer_name["fg"] = "#333333"
txtCustomer_name["justify"] = "left"
txtCustomer_name.place(x=130,y=100,width=409,height=30)
...
lblCustomerID=tk.Label(frmProduct)
ft = tkFont.Font(family='Times',size=10)
lblCustomerID["font"] = ft
lblCustomerID["fg"] = "#333333"
lblCustomerID["justify"] = "left"
lblCustomerID["text"] = "Customer ID"
lblCustomerID.place(x=30,y=70,width=91,height=30)

lblCustomerName=tk.Label(frmProduct)
ft = tkFont.Font(family='Times',size=10)
lblCustomerName["font"] = ft
lblCustomerName["fg"] = "#333333"
lblCustomerName["justify"] = "left"
lblCustomerName["text"] = "Customer Name"
lblCustomerName.place(x=130,y=70,width=412,height=30)
...
lblTitle["text"] = "PRODUCT SALES ENTRY"
